if Menu833sMenu_LOADED and not _G.Menu833sMenu_DEBUG == true then
    -- error("833s Menu is already running!", 0)
    return
end

pcall(function() getgenv().Menu833sMenu_LOADED = true end)
...
MenuMouse = cloneref(Players.LocalPlayer:GetMouse())
...
-- xylex & europa
local menuassets = {
    ["833sMenu/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
    ["833sMenu/assets/close.png"] = "rbxassetid://5054663650",
    ["833sMenu/assets/editaliases.png"] = "rbxassetid://5147488658",
    ["833sMenu/assets/editkeybinds.png"] = "rbxassetid://129697930",
    ["833sMenu/assets/edittheme.png"] = "rbxassetid://4911962991",
    ["833sMenu/assets/editwaypoints.png"] = "rbxassetid://5147488592",
    ["833sMenu/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
    ["833sMenu/assets/logo.png"] = "rbxassetid://128429351840104",
    ["833sMenu/assets/minimize.png"] = "rbxassetid://2406617031",
    ["833sMenu/assets/pin.png"] = "rbxassetid://6234691350",
    ["833sMenu/assets/reference.png"] = "rbxassetid://3523243755",
    ["833sMenu/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        ...
        for _, folder in {"833sMenu", "833sMenu/assets"} do
            if not isfolder(folder) then
                makefolder(folder)
            end
        end
        for path in menuassets do
            if not isfile(path) and path ~= "833sMenu/assets/logo.png" then
                writefile(path, game:HttpGet((path:gsub("833sMenu/", assets))))
            end
        end
        if IsOnMobile then writefile("833sMenu/assets/.nomedia") end
    end)
end
...
Title.TextSize = 18
Title.Text = "833s Menu FE v" .. currentVersion
...
SettingsButton.Image = getcustomasset("833sMenu/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("833sMenu/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("833sMenu/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("833sMenu/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("833sMenu/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("833sMenu/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("833sMenu/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("833sMenu/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("833sMenu/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("833sMenu/assets/pin.png")
...
Logo.Image = getcustomasset("833sMenu/assets/logo.png")
...
Credits.Text = "Developed By Asuneteric"
...
Select_2.BackgroundColor3 = Color3.fromRGB(0,0,0)
...
ExitImage_2.Image = getcustomasset("833sMenu/assets/close.png")
...
Img.Image = getcustomasset("833sMenu/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
About.TextSize = 14
About.Text = "Plugins are .833sMenu files and should be located in the 'workspace' folder of your exploit."
...
ExitImage_3.Image = getcustomasset("833sMenu/assets/close.png")
...
PluginsHint.Text = "Download plugins from the 833sMenu Discord (discord.gg/NrXYbcarDE)"
...
ExitImage_5.Image = getcustomasset("833sMenu/assets/close.png")
...
ImageLabel.Image = getcustomasset("833sMenu/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("833sMenu/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("833sMenu/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/NrXYbcarDE")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/NrXYbcarDE)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
function saves()
    if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
        local readSuccess, out = readfile("833sMenu_FE.833sMenu", true)
        if readSuccess then
            if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
                local success, response = pcall(function()
                    ...
                    if vtype(json.keep833sMenu, "boolean") then Keep833sMenu = json.keep833sMenu else Keep833sMenu = true end
                ...
                if not success then
                    ...
                    writefile("833sMenu_FE.833sMenu", defaults, true)
                    wait()
                    saves()
                end
            else
                writefile("833sMenu_FE.833sMenu", defaults, true)
                wait()
                local dReadSuccess, dOut = readfile("833sMenu_FE.833sMenu", true)
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("833sMenu_FE.833sMenu", HttpService:JSONEncode(update))
	end
end
...
if type(PluginsTable) == "table" then
    for i = #PluginsTable, 1, -1 do
        if string.sub(PluginsTable[i], -9) ~= ".833sMenu" then
...
MenuMouse.KeyDown:Connect(function(Key)
	if (Key==prefix) then
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		Npicker.Default = function(self)
			...
			updateColors(Color3.fromRGB(0,0,0),shade3)
			updateColors(Color3.new(1, 1, 1),text1)
			updateColors(Color3.new(0, 0, 0),text2)
			updateColors(Color3.fromRGB(0,0,0),scroll)
			wait()
			updatesaves()
		end
	else
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- 833s Menu Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
function selectPart()
	...
	local function HighlightPart()
		if selected.Adornee ~= MenuMouse.Target then
			selectionBox.Adornee = MenuMouse.Target
		else
			selectionBox.Adornee = nil
		end
	end
	ActivateHighlight = MenuMouse.Move:Connect(HighlightPart)
	local function SelectPart()
		if MenuMouse.Target ~= nil then
			selected.Adornee = MenuMouse.Target
			Path.Text = getHierarchy(MenuMouse.Target)
		end
	end
	ClickSelect = MenuMouse.Button1Down:Connect(SelectPart)
end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the 833s Menu support server.'}
...
function checkTT()
	local t
	local guisAtPosition = COREGUI:GetGuiObjectsAtPosition(MenuMouse.X, MenuMouse.Y)
	...
	if t ~= nil and t:GetAttribute("Title") ~= nil then
		...
		local xP
		local yP
		if MenuMouse.X > 200 then
			xP = x - 201
		else
			xP = x + 21
		end
		if MenuMouse.Y > (MenuMouse.ViewSizeY-96) then
			yP = y - 97
		else
			yP = y
		end
...
local MousePositionToVector2 = function()
	return Vector2.new(MenuMouse.X, MenuMouse.Y)
end
...
local function clicktpFunc()
	pcall(function()
		...
		local hitPosition = MenuMouse.Hit.Position
...
MenuMouse.Button1Down:Connect(function()
	for i,v in pairs(binds) do
		...
		elseif v.COMMAND == 'clickdel' then
			...
			if input == 'RightClick' and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() MenuMouse.Target:Destroy() end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.gg/NrXYbcarDE')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/NrXYbcarDE')
	else
		notify('Discord Invite', 'discord.gg/NrXYbcarDE')
	end
	if httprequest then
		httprequest({
...
addcmd('serverinfo',{'info','sinfo'},function(args, speaker)
	...
	task.spawn(function()
		...
		ExitImage.Image = getcustomasset("833sMenu/assets/close.png")
		ExitImage.ZIndex = 10
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = MenuMouse.KeyUp:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = MenuMouse.KeyUp:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = MenuMouse.KeyDown:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = MenuMouse.KeyDown:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = PlayerGui:GetGuiObjectsAtPosition(MenuMouse.X, MenuMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd('tptool', {'teleporttool'}, function(args, speaker)
	...
	TpTool.Activated:Connect(function()
		...
		HRP.CFrame = CFrame.new(MenuMouse.Hit.X, MenuMouse.Hit.Y + 3, MenuMouse.Hit.Z, select(4, HRP.CFrame:components()))
	end)
end)
...
addcmd('hovername',{},function(args, speaker)
	...
	nbUpdateFunc = MenuMouse.Move:Connect(updateNameBox)
end)
...
addcmd("mutevcs", {}, function(args, speaker)
    for _, plr in getPlayer(args[1], speaker) do
        repeat
            if Players[plr] == speaker then break end
            Services.VoiceChatInternal:SubscribePause(Players[plr].UserId, true)
        until true
    end
end)

addcmd("unmutevcs", {}, function(args, speaker)
    for _, plr in getPlayer(args[1], speaker) do
        repeat
            if Players[plr] == speaker then break end
...
MenuMouse.Move:Connect(checkTT)
